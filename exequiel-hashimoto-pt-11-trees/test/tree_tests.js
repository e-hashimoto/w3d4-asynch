...
try {
  ({ TreeNode, findLeftMostNodes } = require('../tree_project'));
...
describe('Left Only', () => {
  ...
  context('Leftmost at level', () => {
    ...
    it(`Produces an array with the leftmost element in each level`, () => {
      ...
      const leftMostNodes = findLeftMostNodes(leftOnly)
...
describe('Triangle tree', () => {
  ...
  context('Leftmost at level', () => {
    ...
    it(`Produces an array with the leftmost element in each level`, () => {
      ...
      const leftMostNodes = findLeftMostNodes(triangleTree)
...
describe('Simple Tree', () => {
  ...
  context('Leftmost at level', () => {
    ...
    it(`Produces an array with the leftmost element in each level`, () => {
      ...
      const leftMostNodes = findLeftMostNodes(simpleTree)
...
describe('Complex Tree', () => {
  ...
  context('Leftmost at level', () => {
    ...
    it(`Produces an array with the leftmost element in each level`, () => {
      ...
      const leftMostNodes = findLeftMostNodes(complexTree)
...
describe('Letter Tree', () => {
  ...
  context('Leftmost at level', () => {
    ...
    it(`Produces an array with the leftmost element in each level`, () => {
      ...
      const leftMostNodes = findLeftMostNodes(letterTree)
...
describe('Negative Numbers', () => {
  ...
  context('Leftmost at level', () => {
    ...
    it(`Produces an array with the leftmost element in each level`, () => {
      ...
      const leftMostNodes = findLeftMostNodes(negativeTree)
